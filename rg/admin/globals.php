...
function unregisterGlobals()
{
	...
	if (isset( $_SESSION )){checkInputArray( $_SESSION );}
	$REQUEST = $_REQUEST;
	$GET = $_GET;
	$POST = $_POST;
	$COOKIE = $_COOKIE;
...
function registerGlobals()
{
	...
	if (isset( $_SESSION )){checkInputArray( $_SESSION, true );}
...
if (RG_EMULATION == 0){unregisterGlobals();}// force register_globals = off
else if (ini_get('register_globals') == 0){registerGlobals();}// php.ini has register_globals = off and emulate = on
else {
