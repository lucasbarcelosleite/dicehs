...
class WConfig {
	...
	// Head Configs
	// ===========================================================
	public static $siteName = "Dice Hobby Store - Rio Grande";
	...
	public static $nameGroup = "Dice Hobby Store - Rio Grande";
	...
	public static $dbHost = "internal-db.s41074.gridserver.com";
	public static $dbUser = "db41074_dicehs";
	public static $dbPassword = "10dicehs74";
	public static $dbDatabase = "db41074_dicehs";

	public static $dbPrefix = array("#__" => "rg_", "#U_" => "rg_", "#M_" => "rg_", "#D_" => "rg_", "#C_" => "rg_", "#S_" => "share_");
