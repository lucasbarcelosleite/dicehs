...
while (!file_exists("configuration.php")) {
	chdir("../");
}
require "configuration.php";
require API_PATH."/path.class.php";
...
function CheckAuthentication()
{
	...
	return $_SESSION["usuario_id_usuario"] ? true : false;
}
...
/*
 ...
 ATTENTION: The trailing slash is required.
 */
$baseDir = WPath::arquivoRoot("", "editor");
 ...
 */
$config['FilesystemEncoding'] = WConfig::$siteEncoding;
