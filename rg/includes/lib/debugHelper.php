...
////////////////////////////////////////////////////////////////////////
 ...
 function trace($retornar = false) {
 	global $debug;
 	$debug->options["echoResult"] = false;
 	$trace = $debug->trace();
 	$debug->options["echoResult"] = true;
 	...
 	if ($retornar) {
 		...
 		echo '<fieldset style="color: '.$cor.'; border: '.$cor.' 2px solid; background: '.$fundo.'; font-family: Verdana; font-size:12px; text-align:left;">
           <legend><b><font color="'.$cor.'">DEBUG '.$descricao.'</font></b></legend>
