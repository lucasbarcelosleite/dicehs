...
class HTML2FPDF extends FPDF
{
	...
	function Header($content='')
	{
		...
		if($this->texto){
			...
			if($this->link){
				$tam1 = $this->GetStringWidth($this->texto);
				$tam2 = $this->GetStringWidth($this->link);
				 
				$this->Cell((190 - ($tam1+$tam2+3)),10,'');
				$this->Cell($tam1,10,$this->texto,0,0,'C');
				$this->Cell(3,10,' - ',0,0,'C');
				$this->Cell($tam2,10,$this->link,0,0,'C',0,$this->link);
			}else{
				$this->Cell(0,10,$this->texto,0,0,'R');
			}
