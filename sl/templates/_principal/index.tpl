...
<body class="pull_top {css_menu}">
    ...
    <div class="navbar transparent navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container">
            ...
            <span class="city">
                <strong>S&atilde;o Leopoldo / RS</strong> <br />
                <a href="http://www.dicehs.com.br/rg/">Acessar loja Rio Grande/RS</a>
            </span>
        ...
        <div class="container">
            <div class="row sections">
                ...
                <div class="span4 testimonials">
                    ...
                    <div class="wrapper">
                        <div class="quote">
                            <a href="http://www.dicehs.com.br/rg/" title="Dice Hobby Store Rio Grande"><img src="{dir_img}/dice-rg.jpg" width="340" height="340"></a>
                        </div>
                    </div>
                </div>
                <div class="span4 contact">
                    ...
                    <div class="fb-like-box" data-href="https://www.facebook.com/dicehobbystore" data-width="300" data-colorscheme="dark" data-show-faces="true" data-header="false" data-stream="false" data-show-border="false"></div>
                </div>
            </div>
        </div>
    </footer>
    ...
    <script>
      ...
      ga('create', 'UA-46106634-2', 'dicehs.com.br');
      ga('send', 'pageview');
